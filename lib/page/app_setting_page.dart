                          ...
                          child: Column(
                            children: [
                              buildItem('打开', onTap: () async {
                                ...
                                // }
                                const MethodChannel getAppIcon =
                                    MethodChannel('GetAppInfo');
                                final String activityName =
                                    await getAppIcon.invokeMethod<String>(
                                  entity.packageName,
                                );
                                const MethodChannel jump =
                                    MethodChannel('jump');
                                jump.invokeMethod(
                                  [entity.packageName, activityName].join('\n'),
                                );
                              ...
                              buildItem('冻结', danger: true),
                              buildItem('隐藏', danger: true),
                            ],
                          ),
                        ),
                      ),
